...
def run(playwright):
    ...
    # Fill in new sender and recipient names
    page.get_by_label("Your Name").fill("New Sender")
    page.get_by_label("Recipient's Name").fill("New Recipient")
    page.get_by_role("button", name="Save Names").click()

    # Take a screenshot to verify the textarea is empty
    page.screenshot(path="jules-scratch/verification/verification-cleared.png")
